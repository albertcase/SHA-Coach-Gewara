...
<div class="popup transition hidden" id="rule-pop">
  <div class="p-model">
    ...
    <div class="p-model-con" id="pop-rule">
        <strong>参与本活动无需以购买蔻驰产品或服务为前提。购买我们的产品或服务并不会增加你在本次活动中的获胜机会。本次活动最终解释权归蔻驰贸易（上海）有限公司所有。
		</strong><br>
        <ol type="1">
            <li>参与资格: 任何中国公民均有资格参与蔻驰微信，赢取唐嫣新片《决战食神》的电影观影券活动。本次活动将严格遵守中华人民共和国的相关法律及法规。参与本活动表示你同意无条件完全遵守本活动细则以及活动主办方的相关决定。</li>
            <li>活动主办方: 蔻驰贸易（上海）有限公司
南京西路1717号会德丰广场20楼，200042.
			</li>
            <li>怎样参与本次活动:
在活动期间，所有添加蔻驰官方微信账号的用户，根据账号内指引扫描活动二维码，提交个人信息，即有资格参加抽奖活动。活动主办方有义务在活动期间保证活动功能可被正常使用。
			</li>
			<li>获奖者的认证：所有的活动参与者都必须满足活动细则中的所有条款。获取奖品的先决条件是必须完成所有相关的任务。主办方不会接受截图或者其他的证据来验证获奖资格。在活动期间，如果在系统出现问题时产生的结果是不会被视作有效的。活动主办方在法律允许范围内负责制定、解释、修改并及时公布本次活动的规则，并最终确定获奖者。
			</li>
			<li>奖品: 由蔻驰提供的唐嫣新年贺岁剧《决战食神》电影票两张（数量有限，送完为止）。</li>
			<li>活动信息公告：本次所有参与活动的用户信息，都将默认成为Coach尊贵的客户（会员）。在符合法律相关规定的情况下，获奖者必须同意活动主办方在媒体上披露获奖者的姓名，微信头像与信息，语音，意见，身份信息和居住城市，主办方并不需要为此再支付额外费用或另行通知。活动主办方有权依据相关法律法规或业务需要，中止或取消此次活动或者修改活动方案，经相关途径公告后生效。</li>
