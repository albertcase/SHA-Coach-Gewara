...
var shareArr = {
    "_title": '收下唐嫣这波美食诱惑，一起相约《决战食神》', //分享标题
    "_desc": "收下唐嫣这波美食诱惑，一起相约《决战食神》",    // 分享朋友圈的描述
    "_desc_friend": "关注Coach的官方微信，赢取唐嫣新片《决战食神》免费电影兑换券2张",    // 分享好友的描述
...
var pfun = {
    init: function(){
        ...
        // wx.hideMenuItems({
        //     menuList: ["appMessage", "timeline"] // 要隐藏的菜单项，只能隐藏“传播类”和“保护类”按钮，所有menu项见附录3
        // });
        //self.wxshareFun();
    },
...
function gewaraFun(){
    ...
    self.init = function(){   // 初始化执行函数
        ...
        pfun.overscroll(document.querySelector("#pop-codeuse"));  // 活动规则滚动条
    };
    ...
    self.gewaraPrompt = function(node, status){
        if(status){
            ...
            $("#" + node).removeClass("hidden").addClass("ycenter");
        }else{
            $(".popup").addClass("hidden").removeClass("ycenter");
...
$(".codeuse span").on('touchstart', function(e){
    _gewara.gewaraPrompt("codeuse", 1);
    // _hmt.push(['_trackEvent', 'click', 'link', '活动规则']);
    e.preventDefault();
})
...
$(".audioPop").on("touchstart", function(e){
    x.play();
